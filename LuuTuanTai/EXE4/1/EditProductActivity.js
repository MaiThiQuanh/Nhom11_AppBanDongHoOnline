...
export default class EditProductActivity extends Component
{
    ...
    componentDidMount(){
        ...
        this.setState({ 
          ...
          TextInput_maSanPham: this.props.navigation.state.params.masp,
          TextInput_tenSanPham: this.props.navigation.state.params.tensp
        })
       ...
       UpdateStudentRecord = () =>{
        ...
        fetch('http://192.168.1.104/database/2/update.php', {
        method: 'POST',
        headers: {
